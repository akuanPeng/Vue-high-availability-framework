                ...
                <div ref="navWrap" :class="[prefixCls + '-nav-wrap', scrollable ? prefixCls + '-nav-scrollable' : '']">
                    ...
                    <div ref="navScroll" :class="[prefixCls + '-nav-scroll']">
                        <div ref="nav" :class="[prefixCls + '-nav']" class="nav-text" :style="navStyle">
                            ...
                            <div :class="tabCls(item)" v-for="(item, index) in navList" :title="item.title" :draggable="draggable" @dragstart="handleDragstart(index, name)" @click="handleChange(index, name, $event)">
    ...
    export default {
        ...
        methods: {
            ...
            handleChange (index, name, e) {
                ...
                this.$emit('on-click', nav.name, name, e);
            },
            handleDragstart (index, name) {
                const nav = this.navList[index];
                this.$emit('on-dragstart', nav.name, name);
            },
            ...
            handleRemove (index, isDrag) {
                ...
                this.$emit('on-tab-remove', tab.currentName, isDrag);
                this.updateNav();
            },
            showClose (item) {
                if (this.type === 'card') {
